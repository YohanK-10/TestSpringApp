...
export default function register() {
    ...
    const [formDataCp, setFormDataCp] = useState({ confirmPassword: '' });
    ...
    }, [formData.password, formDataCp.confirmPassword]);

    const checkPassword = (pwd: string): string => {
        if (pwd.length == 0) return ''; // No error if empty
    ...
    const validateConfirmPassword = (password: string, confirmPassword: string): string => {
        if (!confirmPassword || !password) return ''; // No error if empty
    ...
    return (
        <div className="flex min-h-screen overflow-hidden">
                    ...
                    <div className="flex flex-col justify-center px-4 py-20 gap-4 w-full max-w-md">
                        ...
                        <form className="w-full" onSubmit={handleSubmit}>
                            <div className="mb-5 grid gap-6 w-full">
                                ...
                                <div className="mt-10 grid w-full">
                                    <div className="relative w-full">
                                        ...
                                        <input
                                            className="flex h-13 w-full rounded-lg border border-gray-500 bg-transparent pl-10 py-2 text-base transition-all duration-200 ease-in-out
                                            hover:border-gray-300 focus:border-transparent focus:outline-[3.5px] focus:outline-white focus:outline-offset-0 focus:transition-none"
                                            id="username"
                                            type="text"
                                    ...
                                    <div className="relative w-full">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                autoComplete="email"
                                                autoCorrect="off"
                                                value={formData.email} // mailbox is onchange and value is windows on it to allow react to actually see the values put in the mailbox.
                                                onChange={(e)=> {
                                        ...
                                        {emailError.length > 0 && (
                                            <p className="text-red-500 text-sm mt-2 pl-2.5">{emailError}</p>
                                        )}
                                    </div>
                                </div>
                                    ...
                                    <div className="relative w-full">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`flex h-13 w-full rounded-lg border border-gray-500 bg-transparent pl-10 pr-10 py-2 text-base transition-all duration-200 ease-in-out
                                                           ${passwordError ? "focus:outline-none border-red-500 focus:border-red-500 border-3" : "focus:border-transparent focus:outline-[3.5px] " +
                                                          "focus:outline-offset-0 focus:transition-none hover:border-gray-300 focus:outline-white"}`}
                                                id="password"
                                ...
                                <div className="grid w-full">
                                    <div className="relative w-full">
                                        <div className="relative">
                                            ...
                                            <input
                                                type={visibleCp ? "text" : "password"}
                                                className={`flex h-13 w-full rounded-lg border border-gray-500 bg-transparent pl-10 pr-10 py-2 text-base transition-all duration-200 ease-in-out
                                                          ${confirmPasswordError ? "focus:outline-none border-red-500 focus:border-red-500 border-3" : "focus:border-transparent focus:outline-[3.5px] " +
                                                        "focus:outline-offset-0 focus:transition-none hover:border-gray-300 focus:outline-white"}`}
                                                id="confirmpassword"
                                                placeholder="Confirm password"
                                                autoCapitalize="none"
                                                autoComplete="current-password"
                                                value={formDataCp.confirmPassword}
                                                onChange={(e) => {
                                                    const newConfirm = e.target.value;
                                                    setFormDataCp({ confirmPassword: newConfirm });
                                                    setConfirmPasswordError(validateConfirmPassword(formData.password, newConfirm));
                                                }}
                                                onBlur={() => {
                                                    setConfirmPasswordError(validateConfirmPassword(formData.password, formDataCp.confirmPassword));
                                                }}
                                                required
                                            />
                                            {/* Password visibility toggle */}
                            ...
                            <div className="flex flex-row">
                                <div className="pl-28 pr-0 mt-4 flex justify-between items-center mb-2">
                                    <p
            ...
            <div className="hidden md:block fixed inset-y-0 right-0 w-[50%] h-screen overflow-hidden z-10">
