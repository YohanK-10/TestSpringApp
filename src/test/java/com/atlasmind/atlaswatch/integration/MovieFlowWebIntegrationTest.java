...
import com.atlasmind.atlaswatch.controller.MovieController;
import com.atlasmind.atlaswatch.controller.ReviewController;
...
import com.atlasmind.atlaswatch.service.MovieService;
    ...
    void coreMovieFlowSearchDetailsAndReviewsWorksOverHttp() throws Exception {
        SearchResponseDto searchResponse = new SearchResponseDto(
                ...
                List.of(new MovieDto(27205L, "Inception", "Dreams within dreams", 99.0,
                        "/poster.jpg", "/backdrop.jpg", "2010-07-16", 8.8, 36_000, List.of(28, 878))),
                1,
                1
        );
